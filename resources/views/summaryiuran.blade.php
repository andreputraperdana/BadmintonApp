...
<html lang="en">
  ...
  <body>
    ...
    <div style="max-width: 100vw; display: flex; justify-content: center">
      <div style="width: 90%;">
        <form action="/summaryiuran" method="POST">
            @csrf
            <fieldset class="border ps-3" style="width: 700px; border: solid 1px black !important;">
                <legend class="lejen w-auto">Summary Iuran</legend>
                <div class="raja">
                  <div class="apaaja">
                  ...
                  >
                    Show Data
                        ...
                        {{-- <tr>
                            <td class="dateFromText" style="width: 150px">Periode</td>
                            <td>:</td>
                            ...
                            <td style="padding-bottom: 50px;">
                              <button type="submit" 
                                class="btn btn-primary" 
                                id="btn_simpan" 
                                style="background-color: #151515; border-radius: 5px; border: none; font-weight: bold; color: white;"
                              >
                                Show Data
                              </button>
                            </td>
        ...
        <table class="table table-bordered border-dark " style="overflow: scroll; max-width: 90vw">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="text-align: center;">Nama Murid</th>
            ...
            @foreach ($semua as $semuas)
              <tbody>
                <tr>
                  ...
                  <td style="text-align: center;">{{ $semuas->nama_murid }}</td>
                  <td style="text-align: center;">{{ $semuas->jenis_iuran }}</td>
                  <td style="text-align: center;">{{ date('d-m-Y', strtotime($semuas->created_at)) }}</td>
                  <td style="text-align: center;">@currency($semuas->nominal_iuran)</td>
                </tr>
              </tbody>
            @endforeach
              <tfoot>
